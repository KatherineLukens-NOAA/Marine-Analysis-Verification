...
run_python_code=run.diurnal_diffs.2vars.job
...
do
  ...
  do
    ...
    do
      ...
      arg14=${hour[$ihour]}
      arg15=${obstype[$iobs]}
      arg16=${filetype[$ifile]}

      #+++++++++++++++++++++++++++++++++
      # Diurnal Cycle Differences
      #+++++++++++++++++++++++++++++++++

      jname=PLOT.diurnal_diffs.2vars
      python_code=MAIN_PLOT.bkg_anl_inc_diags_gridded.diurnal_cycle_diffs.2variables.maps.py

      log=LOG_${jname}_${arg4}_${arg7}_${arg10}_${arg11}_deg${arg12}_${arg14}_${arg15}_${arg16}_${dateSTART}_${dateEND}            # log name containing output log info
      jlog=${jname}_${arg4}_${arg7}_${arg10}_${arg11}_deg${arg12}_${arg14}_${arg15}_${arg16}_${dateSTART}_${dateEND} 	      # log name for job in queue

      rm $log                                             # remove old log file

      sbatch --mem=0 --output=${log} --job-name=${jlog} --account=${account} --partition=${partition} --qos=${qos} --time=${timelimit} --ntasks=${ntasks} --export=INDIR=${dir_src},SCRIPT=${python_code},ARG1=${arg1},ARG2=${arg2},ARG3=${arg3},ARG4=${arg4},ARG5=${arg5},ARG6=${arg6},ARG7=${arg7},ARG8=${arg8},ARG9=${arg9},ARG10=${arg10},ARG11=${arg11},ARG12=${arg12},ARG13=${arg13},ARG14=${arg14},ARG15=${arg15},ARG16=${arg16} ${run_python_code}
